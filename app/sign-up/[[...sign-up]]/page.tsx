      ...
      <div className="hidden lg:flex lg:w-1/2 flex-col justify-between p-12 relative overflow-hidden"
        ...
        <div className="relative space-y-6">
          ...
          <h2 className="text-4xl font-bold text-white leading-tight">
            Get started with<br />
            <span style={{ color: "#4ade80" }}>AI at Eplayment</span>
          </h2>
          <p className="text-gray-400 text-base leading-relaxed max-w-sm">
            Create your account to access step-by-step AI setup guides, security policies, and governance tools.
          </p>
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 py-12">
        ...
        <div className="w-full max-w-md space-y-6">
          <div className="text-center lg:text-left">
            ...
            <p className="text-sm text-gray-400 mt-1">Join Eplayment's AI onboarding platform</p>
          </div>
